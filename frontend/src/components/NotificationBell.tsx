...
export const NotificationBell: React.FC<NotificationBellProps> = ({ psId }) => {
  ...
  if (!isSupported) {
    return <div className="text-gray-500 text-sm" title="Notifications not supported by this browser">🔕 Not Supported</div>;
  }
  ...
  return (
    <button
      ...
      className={`flex items-center space-x-2 px-3 py-1.5 rounded-md transition-colors ${
        isSubscribed ? 'bg-blue-600 hover:bg-blue-700 text-white' : 'bg-gray-800 hover:bg-gray-700 text-gray-300'
      }`}
